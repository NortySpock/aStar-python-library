...
path_list = path.naive_path(start_pos[0],start_pos[1],end_pos[0],end_pos[1])
#test.print_list_of_tuples_on_map(path_dict['open'], '~',my_text_map)
#test.print_list_of_tuples_on_map(path_dict['closed'], '.',my_text_map)
test.print_path_on_map(my_text_map,path_list)
test.pretty_print_map(my_text_map)
# test.check_path_for_validity(start_pos[0],start_pos[1],end_pos[0],end_pos[1],path_list)
