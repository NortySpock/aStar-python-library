...
my_cost_map = test.make_grid(15,15,1) #default cost of 1
...
# path = path.random_detour_path(start_pos[0],start_pos[1],end_pos[0],end_pos[1], my_cost_map)
# test.print_list_of_tuples_on_map(path_dict['open'], '~',my_text_map)
# test.print_list_of_tuples_on_map(path_dict['closed'], '.',my_text_map)
# test.print_path_on_map(my_text_map,path)
